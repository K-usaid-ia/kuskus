import { Project, User, Vendor, Donation, PurchaseOrder, VendorCategory } from '@/types/schema';
...
export const mockProjects: Project[] = [
  {
    ...
    description: 'Building a new primary school with six classrooms to serve the local community',
    organization_id: '2',
    location: {
      country: 'Ghana',
      city: 'Kumasi',
...
export const mockPurchaseOrders: PurchaseOrder[] = [
  {
    ...
    delivery_confirmation: {
      ...
      notes: 'All materials delivered and work completed according to specifications',
      evidence_urls: [
