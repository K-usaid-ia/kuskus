...
const handleDonate = async () => {
  ...
  setDonating(true);
  try {
    const response = await projectsApi.donate(project.id.toString(), donationAmount);
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-indigo-50 p-4 rounded-lg">
              ...
              <div className="mt-2">
                ...
                <button
                  type="button"
                  onClick={() => setShowGasFeeInfo(!showGasFeeInfo)}
                  className="mt-1 text-xs text-indigo-600 hover:text-indigo-800 underline"
                >
                  {showGasFeeInfo ? 'Hide gas fee details' : 'Learn more about gas fees'}
                </button>
