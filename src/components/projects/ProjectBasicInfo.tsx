          ...
          <div>
            ...
            <div className="mt-1">
              ...
              {errors.timeline_start && (
                <p className="mt-1 text-sm text-red-600">{errors.timeline_start.message}</p>
              )}
            </div>
          </div>
            ...
            <div className="mt-1">
              <input
                ...
                {...register("timeline_end", {
                  ...
                  validate: value => 
                    !timeline_start || new Date(value) > new Date(timeline_start) || 
                    "End date must be after start date"
                })}
                className="block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
              />
              {errors.timeline_end && (
                <p className="mt-1 text-sm text-red-600">{errors.timeline_end.message}</p>
              )}
            </div>
          </div>
        </div>
